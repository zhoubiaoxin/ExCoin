...
- (instancetype)initWithListData:(NSArray *)data andSelect:(NSInteger)integer{
    tempIndexPath = integer;
...
- (void)doneAction:(UIButton *)sender{
    if (self.tapDoneAction) {
        self.tapDoneAction(tempIndexPath);
    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tempIndexPath == indexPath.row) {
...
//    cell.selectedImage.image = [UIImage imageNamed:@"icon_big_selected"];
    ...
    self.doneButton.tag = tempIndexPath;
}
@end
