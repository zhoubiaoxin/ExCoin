...
#define kWidthPro                         [UIScreen mainScreen].bounds.size.width/375
#define kHeightPro                        [UIScreen mainScreen].bounds.size.height/667


/******************    TabBar          *************/
#define StoryKey   @"storyName"
