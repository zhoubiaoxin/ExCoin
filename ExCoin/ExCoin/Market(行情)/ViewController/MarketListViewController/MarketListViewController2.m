...
@interface MarketListViewController2 ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MarketListViewController2
...
-(void)createData{
    ...
    NSString * str3 = @"WHERE tickername like '%BCH'";
    NSString * str4 = [[NSUserDefaults standardUserDefaults] objectForKey:@"sousu"];
    if (str4.length !=0){
        str3 = [NSString stringWithFormat:@" WHERE tickername like '%@%@BCH'",[str4 uppercaseString],@"%"];
    }
