...
@interface MarketListViewController3 ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView * tableView;
@property(nonatomic,strong)NSArray * dataArr;
@property(nonatomic,assign)BOOL hasPaixu;
@end

@implementation MarketListViewController3
...
-(void)createData{
    ...
    NSString * str3 = @"WHERE tickername like '%BTC'";
    NSString * str4 = [[NSUserDefaults standardUserDefaults] objectForKey:@"sousu"];
    if (str4.length !=0){
        str3 = [NSString stringWithFormat:@" WHERE tickername like '%@%@BTC'",[str4 uppercaseString],@"%"];
    }
