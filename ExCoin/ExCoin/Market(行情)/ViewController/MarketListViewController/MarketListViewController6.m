...
@interface MarketListViewController6 ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView * tableView;
@property(nonatomic,strong)NSArray * dataArr;
@property(nonatomic,assign)BOOL hasPaixu;
@end

@implementation MarketListViewController6
...
-(void)createData{
    ...
    NSString * str3 = @"WHERE tickername like '%USDT'";
    NSString * str4 = [[NSUserDefaults standardUserDefaults] objectForKey:@"sousu"];
    if (str4.length !=0){
        str3 = [NSString stringWithFormat:@" WHERE tickername like '%@%@USDT'",[str4 uppercaseString],@"%"];
    }
